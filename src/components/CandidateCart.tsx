...
const CandidateCart = (props: PropType) => {
  const { candidateData, masterData } = props;
  ...
  return (
    <div>
      {candidateData?.map((data: any, i: number) => (
        <div
          key={i}
          className="lg:w-full flex lg:justify-around pb-3 gap-x-1 my-10 border shadow rounded-lg shadow-black-50/20"
        >
            ...
            <ul className="list-outside flex flex-wrap lg:mt-11 gap-x-3">
              ...
              <li className="text-style">
                ...
                <p className="space-x-2">
                  <span>Form {formateDate(data.next_job_available_date)}</span>
                  <span>|</span>
